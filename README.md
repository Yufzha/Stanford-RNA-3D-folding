...
During the Future data phase, this folder will be updated to include all RNA structure entries in the PDB at the date of future evaluation, including entries released after the Final Submission Deadline.
Additional notes
